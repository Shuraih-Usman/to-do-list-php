...
<div class="wrapper">
    ...
    <div class="right-column">
            <h2>About</h2>
            <p>This is a simple To-do list application created by Shuraih Usman, the App was develope using HTML, CSS, and PHP, there wasn't any database interaction, it is a Server Side application that i integrate using SESSION as the means of authentication and storing all the data inserted to the Session array, then called the session array. The Delete fucntion is implemented by taking the array base on it's index number an unset it using PHP UNSET Function.</p>
        </div>
        </div>
        <br>
        <center>To-Do List App - 2023 | Design with ♥ by <a href="//fb.me/shuraih.usman">Shuraih 99%</a></center>
    </div>
